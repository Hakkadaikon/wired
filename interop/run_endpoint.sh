...
# RFC 9000 9.6: advertise this server at udp/4433 as the preferred_address;
# the SDK binds a second socket on that port and answers migrated clients
# from it (RFC 9000 9.6.2).
MIGRATE=""
