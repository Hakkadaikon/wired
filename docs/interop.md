...
| `goodput` (measurement) | ✅ | 10 MB at 9372±14 kbps over the runner's simulated 10 Mbps link (5-run pooled, as of `72914d2`) — on par with ngtcp2 (9381) and picoquic (9328) |
