#ifndef HANDSHAKE_DRIVE_RETRY_DRIVE_H
#define HANDSHAKE_DRIVE_RETRY_DRIVE_H
...
/** Destination for retry_process: the extracted token (via the obuf) and
