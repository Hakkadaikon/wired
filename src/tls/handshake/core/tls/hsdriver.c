...
void quic_hsdriver_cert_verified(quic_hsdriver* s) { s->cert_verified = 1; }

int quic_hsdriver_complete(const quic_hsdriver* s) { return s->complete; }

int quic_hsdriver_confirmed(const quic_hsdriver* s) { return s->confirmed; }
