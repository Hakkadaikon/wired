#ifndef TLS_SERVERHELLO_H
#define TLS_SERVERHELLO_H
...
/** Output of tls_parse_server_hello: the negotiated cipher_suite and the
 ...
 * success, 0 under the same conditions as tls_parse_server_hello, or if
