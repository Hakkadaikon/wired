#ifndef TLS_INITIAL_H
#define TLS_INITIAL_H
...
typedef struct {
  u8 key[AEAD_KEY_MAX]; /**< AEAD packet protection key */
  u8 iv[INITIAL_IV];    /**< AEAD IV */
  u8 hp[AEAD_KEY_MAX];  /**< header protection key */
} initial_keys;
