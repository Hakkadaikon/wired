...
int earlydata_can_send(int has_0rtt_keys, int resumption_offered);
...
int earlydata_must_resend(int server_accepted_0rtt);
 ...
 * handshake. */
int earlydata_can_migrate(int new_path_validated, int handshake_confirmed);
