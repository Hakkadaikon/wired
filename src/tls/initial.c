...
static const u8 INITIAL_SALT[20] = {
    0x38,0x76,0x2c,0xf7,0xf5,0x59,0x34,0xb3,0x4d,0x17,
    0x9a,0xe6,0xa4,0xc8,0x0c,0xad,0xcc,0xbb,0x7f,0x0a
};

/* Expand-Label one field from the per-side secret into out[0..len). */
static void derive_field(const u8 *secret, const char *label, usz label_len,
                         u8 *out, usz len)
{
...
static void derive_keys(const u8 secret[QUIC_HKDF_PRK], quic_initial_keys *out)
{
