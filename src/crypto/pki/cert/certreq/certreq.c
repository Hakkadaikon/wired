...
static int split_body(const u8 *b, usz n, const u8 **ctx, u8 *ctx_len,
                      const u8 **ext, usz *ext_len)
{
    usz e;
...
static int sig_algs_here(const u8 *ext, usz n, usz q, usz dlen, const u8 **sa,
                         usz *sa_len)
{
...
static int certreq_parse_body(const u8 *b, usz n, const u8 **ctx, u8 *ctx_len,
