...
static int outer_next(quic_derseq* c, wired_span* whole, quic_der_tlv* e) {
...
static int take_fields(wired_span seq, quic_x509* out) {
  quic_derseq c;
...
static int at_extensions(wired_span tbs, quic_derseq* c) {
