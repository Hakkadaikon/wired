...
static inline u8 ct_diff16(const u8 a[16], const u8 b[16]) {
  u8 d = 0;
...
static inline u8 ct_diff32(const u8 a[32], const u8 b[32]) {
  u8 d = 0;
...
static inline u8 ct_diff8(const u8 a[8], const u8 b[8]) {
  u8 d = 0;
 ...
 * equal. */
static inline u8 ct_diffn(const u8* a, const u8* b, usz n) {
  u8 d = 0;
