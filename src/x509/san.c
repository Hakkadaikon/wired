...
static int san_reach_extensions(const u8 *tbs, usz tbs_len, const u8 **ext, usz *elen)
{
    quic_derseq c;
    const u8 *val;
    usz vlen;
...
static int dnsname_matches(u8 tag, const u8 *e, usz elen,
                           const u8 *host, usz hlen)
{
