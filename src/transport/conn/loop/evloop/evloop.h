...
typedef struct {
  connloop gate; /* RFC 9000 12.2: send/recv/ack/pto/close gating */
  ...
  evloop_timer pto;  /* RFC 9002 6.2 */
  evloop_timer loss; /* RFC 9002 6.1 */
  evloop_timer idle; /* RFC 9000 10.1 */
...
/** Everything evloop_init needs besides the loop itself. */
typedef struct {
  int level;
  u64 cwnd;
  usz send_len;
