...
int spin_disabled(u8 rand_byte);

/* Like spin_outgoing, but sends 0 unconditionally when `disabled` (the
 * connection's own spin_disabled draw) is set. */
