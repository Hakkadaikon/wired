...
/* RFC 9000 19.6 */
int quic_crypto_stream_recv(quic_crypto_rx* r, u64 offset, wired_span data) {
...
int quic_crypto_stream_recv_ec(
    quic_crypto_rx* r, u64 offset, wired_span data, u64* error_code) {
...
/* RFC 9000 7.5 */
int quic_crypto_stream_read(quic_crypto_rx* r, wired_obuf* out) {
