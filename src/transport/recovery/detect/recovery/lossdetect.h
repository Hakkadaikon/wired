#ifndef RECOVERY_LOSSDETECT_H
#define RECOVERY_LOSSDETECT_H
...
#define LOSS_PACKET_THRESHOLD 3 /* kPacketThreshold */
#define LOSS_TIME_NUM 9         /* kTimeThreshold = 9/8 */
#define LOSS_TIME_DEN 8
