...
static void first_sample(rtt* r, u64 latest) {
  r->min_rtt      = latest;
...
static u64 adjust(const rtt* r, u64 latest, u64 ack_delay) {
...
static void next_sample(rtt* r, u64 latest, u64 ack_delay) {
...
void rtt_on_persistent(rtt* r, u64 latest_rtt) { r->min_rtt = latest_rtt; }
