...
static int read_cids(quic_span buf, usz *off, quic_header *h) {
...
static usz parse_short(const u8 *buf, usz n, quic_header *h) {
...
static void write_cids(quic_obuf *out, const quic_header *h) {
