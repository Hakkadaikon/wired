...
static int put_ack_pairs_ecn(
    u8 *buf, usz cap, usz *off, const quic_ack_frame *f) {
...
static int take_ack_head(
    const u8 *buf, usz n, usz *off, quic_ack_frame *f, u64 *count) {
  u64 largest, first;
