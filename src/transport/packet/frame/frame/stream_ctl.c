...
static int put_rs_tail(wired_obuf* o, const reset_stream_frame* f) {
...
static int take_rs_head(wired_span in, usz* off, reset_stream_frame* f) {
...
static int rs_at_size_ok(const reset_stream_at_frame* f) {
...
static int put_rsat_tail(wired_obuf* o, const reset_stream_at_frame* f) {
...
static int put_rsat_body(wired_obuf* o, const reset_stream_at_frame* f) {
...
/* Read stream_id then error_code. Returns 1 ok, 0 truncated. */
static int take_rsat_head(wired_span in, usz* off, reset_stream_at_frame* f) {
...
static int take_rsat_tail(wired_span in, usz* off, reset_stream_at_frame* f) {
...
static int take_rsat_body(wired_span in, usz* off, reset_stream_at_frame* f) {
