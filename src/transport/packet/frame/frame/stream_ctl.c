...
static int put_rs_head(
    u8 *buf, usz cap, usz *off, const quic_reset_stream_frame *f) {
...
static int take_rs_head(
    const u8 *buf, usz n, usz *off, quic_reset_stream_frame *f) {
...
static int put_ss_head(
    u8 *buf, usz cap, usz *off, const quic_stop_sending_frame *f) {
