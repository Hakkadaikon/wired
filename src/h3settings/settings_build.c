#include "h3settings/settings_build.h"
#include "h3/frame.h" /* quic_h3_settings, quic_h3_settings_put, QUIC_H3_SETTINGS_MAX_FIELD_SECTION_SIZE */
...
/* RFC 9114 7.2.4 */
int quic_h3settings_build(u64 max_field_section_size,
