                          ...
                          usz cap, usz *out_len)
{
    ...
    return quic_h3req_enc_pseudo(method, m_len, path, p_len, scheme, 5,
                                 authority, a_len, out, cap, out_len);
}
                       ...
                       usz a_len, u8 *out, usz cap, usz *out_len)
{
    ...
    return quic_h3req_enc_method(method, 3, path, p_len, authority, a_len, out,
                                 cap, out_len);
}
