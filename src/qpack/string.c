...
static int str_raw(const u8 *buf, usz n, usz off, u8 *dst, usz dcap, usz len,
                   usz *out_len)
{
...
static int str_value(const u8 *buf, usz n, usz off, int huff, u8 *dst,
                     usz dcap, usz len, usz *out_len)
{
