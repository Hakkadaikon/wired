#ifndef H3_SETTINGS_CHECK_H
#define H3_SETTINGS_CHECK_H
...
#define H3_SETTING_RESERVED_LOW 0x02
#define H3_SETTING_RESERVED_HIGH 0x05
 ...
 * other's headers. */
#define H3_SETTING_H3_DATAGRAM 0x33
