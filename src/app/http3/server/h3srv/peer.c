 ...
 * SETTINGS-first. */
static u16 peer_control_error(const quic_h3srv_state *st, u64 ft) {
...
int quic_h3srv_on_peer_control(
    quic_h3srv_state *st, u64 first_frame_type, u16 *err) {
...
int quic_h3srv_accept_uni(u64 stream_type) {
