 ...
 * form for the 1-RTT space. On success *level is the QUIC_LEVEL_* the packet
 * was opened at, payload/payload_len the recovered plaintext frames (a view
 * into dgram). Returns 1, or 0 on an unhandled type, a missing peer key, or
 * AEAD failure. */
