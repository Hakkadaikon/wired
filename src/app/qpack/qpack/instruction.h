#ifndef QPACK_INSTRUCTION_H
#define QPACK_INSTRUCTION_H
...
typedef enum {
  QPACK_ENC_SET_CAPACITY,    /* 4.3.1  001xxxxx, 5-bit Capacity */
  QPACK_ENC_INSERT_NAME_REF, /* 4.3.2  1Txxxxxx, 6-bit Name Index */
  QPACK_ENC_INSERT_LITERAL,  /* 4.3.3  01Hxxxxx, 5-bit Name Length */
  QPACK_ENC_DUPLICATE,       /* 4.3.4  000xxxxx, 5-bit Index */
} qpack_enc_kind;

/** Decoder-stream instruction kinds (RFC 9204 4.4), by leading bit pattern. */
typedef enum {
  QPACK_DEC_SECTION_ACK,   /* 4.4.1  1xxxxxxx, 7-bit Stream ID */
  QPACK_DEC_STREAM_CANCEL, /* 4.4.2  01xxxxxx, 6-bit Stream ID */
  QPACK_DEC_INSERT_COUNT,  /* 4.4.3  00xxxxxx, 6-bit Increment */
} qpack_dec_kind;
