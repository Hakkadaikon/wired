...
static void mul_step(quic_bn *r, int add_a, const quic_bn *a, const quic_bn *m)
{
...
static void modmul(quic_bn *r, const quic_bn *a, const quic_bn *b,
                   const quic_bn *m)
{
    quic_bn acc = {{0}};
...
void quic_bn_modexp(quic_bn *out, const quic_bn *base,
                    const quic_bn *exp, const quic_bn *mod)
{
    quic_bn result = {{0}};
