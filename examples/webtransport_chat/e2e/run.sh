...
# this, and README.md's "Load testing" section for the numbers it reports.
set -euo pipefail

cd "$(dirname "$0")/.."   # examples/webtransport_chat/

SERVER_LOG="$(mktemp)"
FRONTEND_PORT=8091   # distinct from serve-frontend's 8443 / dev-frontend's 3000
