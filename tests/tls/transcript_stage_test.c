...
static void test_transcript_stage_ch_sh(void) {
  ...
  CHECK(ts_digest_eq(
      d, "6f50d04ebccfc92fab762e6ece797de3c0c6d62e02feb988d8dffe69a81566d4"));
}
...
static void test_transcript_stage_ch_sfin(void) {
  ...
  transcript_ch_sfin(&t, d); /* ClientHello..server Finished stage */
  CHECK(ts_digest_eq(
      d, "5bf53862cbd11fca4c1308918e02e4e39b0f13ad1c44b58411b5041df7294754"));
}
