...
void test_appkeys(void)
{
    ...
    quic_tls_app_keys(ms, transcript, sizeof(transcript), 0, &c);
    quic_tls_app_keys(ms, transcript, sizeof(transcript), 0, &c2);
    quic_tls_app_keys(ms, transcript, sizeof(transcript), 1, &s);
    ...
    quic_tls_handshake_keys(ms, transcript, sizeof(transcript), 0, &hk);
    differ = 0;
