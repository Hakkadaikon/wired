 ...
 * outrank neither way (same rule as h3_priority_higher). */
static void test_dgpriority_higher(void) {
  CHECK(dgpriority_higher(1, 3) == 1);
  CHECK(dgpriority_higher(3, 1) == 0);
  CHECK(dgpriority_higher(3, 3) == 0);
}
