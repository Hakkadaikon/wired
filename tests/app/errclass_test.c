...
static void test_reserved(void) {
  CHECK(h3_error_is_reserved(0x21) == 1); /* N=0 */
  CHECK(h3_error_is_reserved(0x21 + 0x1f * 9) == 1);
  CHECK(h3_error_is_reserved(0x20) == 0);
  CHECK(h3_error_is_known(0x21) == 0); /* reserved != known */
}

/* RFC 9114 8.1 / 9114-077: h3_error_send_value substitutes grease_id for
