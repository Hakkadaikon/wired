...
static void test_datagram_with_len(void) {
  ...
  u8                  buf[16];
  usz w = quic_datagram_encode(wired_mspan_of(buf, sizeof(buf)), &in, 1);
...
static void test_datagram_no_len(void) {
  ...
  u8                  buf[16];
  usz w = quic_datagram_encode(wired_mspan_of(buf, sizeof(buf)), &in, 0);
...
static void test_datagram_truncated(void) {
  ...
  usz ew = quic_datagram_encode(wired_mspan_of(buf, sizeof(buf)), &e, 1);
