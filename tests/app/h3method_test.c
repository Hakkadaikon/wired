...
static void test_h3method_known_methods(void) {
  CHECK(h3_method_is_known(METHOD("GET")) == 1);
  CHECK(h3_method_is_known(METHOD("HEAD")) == 1);
  CHECK(h3_method_is_known(METHOD("POST")) == 1);
  CHECK(h3_method_is_known(METHOD("PUT")) == 1);
  CHECK(h3_method_is_known(METHOD("DELETE")) == 1);
  CHECK(h3_method_is_known(METHOD("CONNECT")) == 1);
  CHECK(h3_method_is_known(METHOD("OPTIONS")) == 1);
  CHECK(h3_method_is_known(METHOD("TRACE")) == 1);
  CHECK(h3_method_is_known(METHOD("PATCH")) == 1);
}
...
static void test_h3method_unknown_method(void) {
  CHECK(h3_method_is_known(METHOD("FOOBAR")) == 0);
  CHECK(h3_method_is_known(METHOD("")) == 0);
}
...
static void test_h3method_case_sensitive(void) {
  CHECK(h3_method_is_known(METHOD("get")) == 0);
}

/* Boundary: a prefix or superset of a known name does not match. */
static void test_h3method_no_partial_match(void) {
  CHECK(h3_method_is_known(METHOD("GE")) == 0);
  CHECK(h3_method_is_known(METHOD("GETX")) == 0);
}
...
static void test_h3method_allowed_methods(void) {
  CHECK(h3_method_is_allowed(METHOD("GET")) == 1);
  CHECK(h3_method_is_allowed(METHOD("HEAD")) == 1);
  CHECK(h3_method_is_allowed(METHOD("POST")) == 1);
  CHECK(h3_method_is_allowed(METHOD("PUT")) == 1);
  CHECK(h3_method_is_allowed(METHOD("DELETE")) == 1);
  CHECK(h3_method_is_allowed(METHOD("OPTIONS")) == 1);
  CHECK(h3_method_is_allowed(METHOD("PATCH")) == 1);
  CHECK(h3_method_is_allowed(METHOD("CONNECT")) == 1);
}
...
static void test_h3method_recognized_not_allowed(void) {
  CHECK(h3_method_is_allowed(METHOD("TRACE")) == 0);
  CHECK(h3_method_is_allowed(METHOD("FOOBAR")) == 0);
}
