...
static void test_0rtt_accept_meets_or_exceeds_issued(void) {
  CHECK(quic_datagram_0rtt_accept_ok(1200, 1200) == 1); /* boundary: equal */
  CHECK(quic_datagram_0rtt_accept_ok(1200, 65535) == 1);
  CHECK(quic_datagram_0rtt_accept_ok(0, 0) == 1); /* neither ever supported */
}
...
static void test_0rtt_accept_below_issued_rejected(void) {
  CHECK(quic_datagram_0rtt_accept_ok(1200, 1199) == 0); /* boundary: -1 */
  CHECK(quic_datagram_0rtt_accept_ok(65535, 0) == 0);
}
