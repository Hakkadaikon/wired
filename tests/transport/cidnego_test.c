...
static void test_cidnego_adopt(void) {
  ...
  CHECK(ob.len == 5);
  CHECK(
      quic_cidnego_match(wired_span_of(dcid, ob.len), wired_span_of(scid, 5)) ==
      1);
}
...
static void test_cidnego_zero_len(void) {
  ...
  CHECK(ob.len == 0);
  CHECK(
      quic_cidnego_match(wired_span_of(dcid, 0), wired_span_of(dcid, 0)) == 1);
}
...
static void test_cidnego_len_bounds(void) {
  ...
  CHECK(
      ...
      ob.len == 20);
  CHECK(quic_cidnego_peer_dcid(wired_span_of(scid, 21), &ob) == 0);
}
...
static void test_cidnego_match_neg(void) {
  ...
  u8 b[3] = {1, 2, 4};
  CHECK(
      quic_cidnego_match(wired_span_of(a, 3), wired_span_of(b, 3)) ==
      0); /* last byte differs */
  CHECK(
      quic_cidnego_match(wired_span_of(a, 3), wired_span_of(a, 2)) ==
      0); /* length differs */
  CHECK(quic_cidnego_match(wired_span_of(a, 2), wired_span_of(a, 2)) == 1);
}
