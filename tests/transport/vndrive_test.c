...
static void test_accept_pre_handshake(void) {
  ...
  CHECK(
      quic_vndrive_accept(0, QUIC_VERSION_1, quic_verlist_of(offered, 2)) == 1);
  CHECK(
      quic_vndrive_accept(1, QUIC_VERSION_1, quic_verlist_of(offered, 2)) == 0);
}
...
static void test_accept_downgrade(void) {
  ...
  CHECK(
      quic_vndrive_accept(0, QUIC_VERSION_1, quic_verlist_of(offered, 2)) == 0);
  CHECK(
      quic_vndrive_accept(0, QUIC_VERSION_2, quic_verlist_of(offered, 2)) == 0);
}
...
static void test_select_pref(void) {
  ...
  CHECK(
      quic_vndrive_select(
          quic_verlist_of(offered, 2), quic_verlist_of(sup2, 2), &chosen) == 1);
  ...
  CHECK(
      quic_vndrive_select(
          quic_verlist_of(offered, 2), quic_verlist_of(sup1, 2), &chosen) == 1);
...
static void test_select_none(void) {
  ...
  CHECK(
      quic_vndrive_select(
          quic_verlist_of(offered, 1), quic_verlist_of(sup, 2), &chosen) == 0);
}
