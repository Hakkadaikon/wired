...
static void test_protect_roundtrip(void) {
  ...
  protect_open_io oio = {wired_mspan_of(pkt, total), 18, 14, 4, 2};
  usz             pl  = protect_open(&k, &oio);
