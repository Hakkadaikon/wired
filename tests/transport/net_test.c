...
static void test_udp_checksum(void)
{
    ...
    usz n = quic_udp4_build(dg, sizeof(dg), 0x1234, 0x4321,
                            0x7f000001, 0x7f000002, pl, 4);
...
static void test_net_datagram_over_link(void)
{
    ...
    usz un = quic_udp4_build(udp, sizeof(udp), 9000, 443,
                             0x0a000001, 0x0a000002, pl, 5);
    quic_ipv4_build(ip, (u16)(QUIC_IPV4_HDR + un), 0x0a000001, 0x0a000002,
                    QUIC_IP_PROTO_UDP);
