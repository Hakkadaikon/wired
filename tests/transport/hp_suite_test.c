...
void test_hp_suite(void)
{
    ...
    CHECK(quic_hp_suite_mask(QUIC_TLS_AES_128_GCM_SHA256, aes_key, sample, mask) == 1);
    quic_aes128 hp;
    ...
    u8 cha_key[32];
    hps_uhx("25a282b9e82f06f21f488917a4fc8f1b73573685608597d0efcb076b0ab7a7a4",
            cha_key, 32);
    hps_uhx("5e5cd55c41f69080575d7999c25a5bfb", sample, 16);
    CHECK(quic_hp_suite_mask(QUIC_TLS_CHACHA20_POLY1305_SHA256, cha_key, sample, mask) == 1);
    u8 want_cha[5];
