...
static const u8 V2_GOLDEN[20] = {0x0d, 0xed, 0xe3, 0xde, 0xf7, 0x00, 0xa6,
                                 0xdb, 0x81, 0x93, 0x81, 0xbe, 0x6e, 0x26,
                                 0x9d, 0xcb, 0xf9, 0xbd, 0x2e, 0xd9};

/* RFC 9001 5.2 v1 Initial salt, exact golden value. */
static const u8 V1_GOLDEN[20] = {0x38, 0x76, 0x2c, 0xf7, 0xf5, 0x59, 0x34,
...
static void test_unknown_version(void) {
  ...
  usz       len = 99;
  CHECK(version_initial_salt(0xdeadbeefu, &s, &len) == 0);
