...
static void test_max_data(void) {
  ...
  CHECK(max_data_decode(buf, w - 1, &out) == 0);
}
...
static void test_data_blocked(void) {
  ...
  CHECK(data_blocked_decode(buf, w - 1, &out) == 0);
}
...
static void test_max_stream_data(void) {
  ...
  CHECK(max_stream_data_decode(buf, w - 1, &out) == 0);
}
...
static void test_stream_data_blocked(void) {
  ...
  CHECK(stream_data_blocked_decode(buf, w - 1, &out) == 0);
}
...
static void test_max_streams_bidi(void) {
  ...
  CHECK(max_streams_decode(buf, w - 1, &out) == 0);
}
...
static void test_streams_blocked_bidi(void) {
  ...
  CHECK(streams_blocked_decode(buf, w - 1, &out) == 0);
}
