...
void test_retrytoken(void) {
  ...
  quic_retrytoken_in in  = {wired_span_of(addr, 4), wired_span_of(odcid, 8)};
  quic_retrytoken_in in2 = {wired_span_of(addr2, 4), wired_span_of(odcid, 8)};
  ...
  quic_retrytoken_in in_odcid2 = {
      wired_span_of(addr, 4), wired_span_of(odcid2, 8)};
