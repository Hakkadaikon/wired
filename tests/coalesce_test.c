...
static void test_coalesce_truncated(void)
{
    ...
    usz n = 0;
    dg[n++] = 0xC0;
    dg[n++] = 0; dg[n++] = 0; dg[n++] = 0; dg[n++] = 1;
    dg[n++] = 0; dg[n++] = 0; dg[n++] = 0; /* DCID/SCID/token lens */
