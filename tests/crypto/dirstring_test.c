...
static void test_dirstring_case_insensitive(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_hello, sizeof(dst_hello)),
          quic_span_of(dst_hello_lower, sizeof(dst_hello_lower))) == 1);
}
...
static void test_dirstring_different_rejects(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_hello, sizeof(dst_hello)),
          quic_span_of(dst_world, sizeof(dst_world))) == 0);
}
...
static void test_dirstring_internal_space_collapses(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_internal_ws, sizeof(dst_internal_ws)),
          quic_span_of(dst_internal_one, sizeof(dst_internal_one))) == 1);
}
...
static void test_dirstring_leading_trailing_trimmed(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_padded, sizeof(dst_padded)),
          quic_span_of(dst_bare, sizeof(dst_bare))) == 1);
}
...
static void test_dirstring_non_ascii_identical_matches(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_non_ascii_a, sizeof(dst_non_ascii_a)),
          quic_span_of(dst_non_ascii_b, sizeof(dst_non_ascii_b))) == 1);
}
...
static void test_dirstring_non_ascii_different_rejects(void) {
  CHECK(
      quic_x509_dirstring_ci_equal(
          quic_span_of(dst_non_ascii_a, sizeof(dst_non_ascii_a)),
          quic_span_of(dst_non_ascii_c, sizeof(dst_non_ascii_c))) == 0);
}
...
static void test_dn_ci_case_insensitive(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n2, sizeof(dst_n2))) == 1);
}
...
static void test_dn_ci_internal_space_collapses(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n3, sizeof(dst_n3))) == 1);
}
...
static void test_dn_ci_leading_trailing_trimmed(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n4, sizeof(dst_n4))) == 1);
}
...
static void test_dn_ci_different_value_rejects(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n5, sizeof(dst_n5))) == 0);
}
...
static void test_dn_ci_different_type_rejects(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n6, sizeof(dst_n6))) == 0);
}
...
static void test_dn_ci_extra_attribute_rejects(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n7, sizeof(dst_n7))) == 0);
}
...
static void test_dn_ci_rdn_grouping_rejects(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n7, sizeof(dst_n7)),
          quic_span_of(dst_n8, sizeof(dst_n8))) == 0);
}
...
static void test_dn_ci_reflexive(void) {
  CHECK(
      quic_x509_dn_equal_ci(
          quic_span_of(dst_n1, sizeof(dst_n1)),
          quic_span_of(dst_n1, sizeof(dst_n1))) == 1);
}
